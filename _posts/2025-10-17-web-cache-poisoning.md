...
![Web Cache Poisoning Lab 1 Photo 1]({{ site.baseurl }}/images/web_pois_lab1_photo_1.jpg) 
This shows a web cache is being used and a file is loaded from the websec academy by the response


![Web Cache Poisoning Lab 1 Photo 2]({{ site.baseurl }}/images/web_pois_lab1_photo_2.jpg)
...
![Web Cache Poisoning Lab 2 Photo 1]({{ site.baseurl }}/images/web_pois_lab2_photo_1.jpg)
The use of cache


![Web Cache Poisoning Lab 2 Photo 2]({{ site.baseurl }}/images/web_pois_lab2_photo_2.jpg)
The param miner shows query


![Web Cache Poisoning Lab 2 Photo 3]({{ site.baseurl }}/images/web_pois_lab2_photo_3.jpg)
...
5. The lab is solved when a victim visits a page that includes the poisoned `/js/geolocate.js` resource.
   ![Web Cache Poisoning Lab 3 Photo 1]({{ site.baseurl }}/images/web_pois_lab3_photo_1.jpg)
   The request that gets saved in the cache


![Web Cache Poisoning Lab 3 Photo 2]({{ site.baseurl }}/images/web_pois_lab3_photo_2.jpg)
The param miner identified the header


![Web Cache Poisoning Lab 3 Photo 3]({{ site.baseurl }}/images/web_pois_lab3_photo_3.jpg)
...
![Web Cache Poisoning Lab 4 Photo 1]({{ site.baseurl }}/images/web_pois_lab4_photo_1.jpg)
You can manipulate the host header


![Web Cache Poisoning Lab 4 Photo 2]({{ site.baseurl }}/images/web_pois_lab4_photo_2.jpg)
